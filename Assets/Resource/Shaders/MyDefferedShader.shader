Shader "Unlit/MyDefferedShader"
{
    ...
    output.dynamicLightmapUV = input.dynamicLightmapUV.xy * unity_DynamicLightmapST.xy + unity_DynamicLightmapST.zw;
            ...
            FragmentOutput MyGBufferFragment(MyVaryings input) : SV_Target
            {
                ...
                //PBR相关信息
                half smoothness = _MySmoothness;
                half metallic = _MyMetallic;
                ...
                float3 specular = _SpecularColor.rgb*(1-metallic)*kDielectricSpec.a ;
                
                FragmentOutput output;
                output.GBuffer0 = half4(baseColor.rgb, 1); // diffuse           diffuse         diffuse   meta
                output.GBuffer1 = half4(specular, 1); // encoded-normal    encoded-normal  charInfo  smoothness
